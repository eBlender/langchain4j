...
public class AlloyDBCredentials {

    private final String accessKeyId;
    private final String secretAccessKey;
    private final String sessionToken;

    public AlloyDBCredentials(String accessKeyId, String secretAccessKey) {
        this(accessKeyId, secretAccessKey, null);
    }

    public AlloyDBCredentials(String accessKeyId, String secretAccessKey, String sessionToken) {
    ...
    public AlloyDBCredentials toCredentialsProvider() {
